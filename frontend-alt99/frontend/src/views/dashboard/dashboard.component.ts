...
import { SqliteUserDemoComponent } from '../sqlite/sqlite-user-demo.component';
import { DuckdbProductsDemoComponent } from '../duckdb/duckdb-products-demo.component';
import { DuckdbAnalyticsDemoComponent } from '../duckdb/duckdb-analytics-demo.component';
import { WebsocketDemoComponent } from '../websocket/websocket-demo.component';
import { ChartsDemoComponent } from '../charts/charts-demo.component';
import { PdfViewerDemoComponent } from '../pdf/pdf-viewer-demo.component';
import { MapsDemoComponent } from '../maps/maps-demo.component';
import { DatabaseManagementComponent } from '../database/database-management.component';
import { VegaChartsDemoComponent } from '../vega-charts/vega-charts-demo.component';
...
@Component({
  ...
  imports: [
    CommonModule,
    MarkdownModule,
    SqliteUserDemoComponent,
    DuckdbProductsDemoComponent,
    DuckdbAnalyticsDemoComponent,
...
export class DashboardComponent implements OnInit {
  ...
  activeView = signal<string>('INDEX');
  ...
  // Dynamic documentation categories from manifest
  docCategories = signal<any[]>([]);

  // Demo items (static)
  demoItems = signal<NavItem[]>([
    { id: 'demo_sqlite_user', label: 'SQLite Users', icon: '🗄️', active: false },
    { id: 'demo_duckdb_products', label: 'DuckDB Products', icon: '🦆', active: false },
    { id: 'demo_duckdb_analytics', label: 'DuckDB Analytics', icon: '📊', active: false },
    { id: 'demo_websocket', label: 'WebSocket', icon: '🔌', active: false },
    { id: 'demo_chart', label: 'Charts (SVG.js)', icon: '📈', active: false },
    { id: 'demo_pdf', label: 'PDF Viewer', icon: '📄', active: false },
    { id: 'demo_maps', label: 'Maps', icon: '🗺️', active: false },
    { id: 'demo_database', label: 'Database Mgmt', icon: '🗃️', active: false },
  ]);

  // Vega charts menu items
  vegaItems = signal<NavItem[]>([
    { id: 'vega_bar', label: 'Bar Charts', icon: '📊', active: false },
    { id: 'vega_line', label: 'Line Charts', icon: '📈', active: false },
    { id: 'vega_area', label: 'Area Charts', icon: '🌊', active: false },
    { id: 'vega_scatter', label: 'Scatter Plot', icon: '⚬', active: false },
    { id: 'vega_pie', label: 'Pie/Donut', icon: '🥧', active: false },
  ]);
  ...
  loadDocsCategories(): void {
    try {
      ...
      this.logger.info(`Loaded ${categories.length} documentation categories`);
    } catch (error) {
      this.logger.error('Failed to load documentation categories', error);
      this.docCategories.set([]);
    }
  }
